...
After preprocessing, we fit an LSBP model with age and gender as covariates to each biomarker–disease-group combination, allowing either linear effects or a B-spline basis expansion with 0–3 interior knots.
```{r, include=FALSE}
